<%@ Page Title="Cardiac Organellar Protein Atlas Knowledgebase (COPaKB) —— Interactome Mouse Mitochondria" Language="C#" MasterPageFile="~/COPaKB.master" AutoEventWireup="true" CodeFile="interactome_mouse_mitochondria.aspx.cs" Inherits="interactome_drosophila_mitochondria" %>
...
<div class="row-fluid">
    <div class="span12">
        <ul class="breadcrumb">
          ...
          <li class="active">Mouse Mitochondria Interactome</li>
        </ul>
    </div>
</div> <!-- end breadcrumbs -->
...
<div class="row-fluid">
    <div class="span12">
        <h2>Mouse Mitochondria Interactome</h2>
        <p>
