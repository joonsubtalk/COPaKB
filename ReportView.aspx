...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportView.aspx.cs" Inherits="ReportView" Title="Cardiac Organellar Protein Atlas Knowledgebase (COPaKB) —— Report View" %>
		...
		<Header>
            <div class="lblue">
                <div style="padding: 10px 10px 50px 10px; height: 120px;" >							
                    ...
                    <asp:HyperLink ID="hlViewSummary" runat="server" >Show the Statistical Distribution View</asp:HyperLink>&nbsp; <asp:HyperLink ID="SwithTreeView" runat="server" >Switch to List View</asp:HyperLink>
			    </div>
            </div>
		</Header>
		<content>
		<div class="tdText" style="margin:5px;">
...
<RightPanel WidthDefault="950">
    <content>
        <div class="container">
            <div class="lbump">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span10">
                        <asp:Label ID="interactomeDisplay" runat="server"></asp:Label>
                    </div>
                </div>
                <div class="row-fluid">
                    <div class="span2">
        ...
        <script src="./assets/js/bootstrap.min.js"></script>
         <script>
             document.getElementById('mySpl_LeftP_Header').style.height = '120px';
         </script>
	</body>
</html>
