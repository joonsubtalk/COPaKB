<%@ Page Title="Cardiac Organellar Protein Atlas Knowledgebase (COPaKB) —— Interactome Human Mitochondria" Language="C#" MasterPageFile="~/COPaKB.master" AutoEventWireup="true" CodeFile="interactome_human_mitochondria.aspx.cs" Inherits="interactome_drosophila_mitochondria" %>
...
<div class="row-fluid">
    <div class="span12">
        <ul class="breadcrumb">
          ...
          <li class="active">Human Mitochondria Interactome</li>
        </ul>
    </div>
</div> <!-- end breadcrumbs -->
...
<div class="row-fluid">
    <div class="span12">
        <h2>Human Mitochondria Interactome</h2>
        <p>
