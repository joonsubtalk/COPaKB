<%@ Page Title="Cardiac Organellar Protein Atlas Knowledgebase (COPaKB) —— Interactome Human Proteasome" Language="C#" MasterPageFile="~/COPaKB.master" AutoEventWireup="true" CodeFile="interactome_human_proteasome.aspx.cs" Inherits="interactome_drosophila_mitochondria" %>
...
<div class="row-fluid">
    <div class="span12">
        <ul class="breadcrumb">
          ...
          <li class="active">Human Proteasome Interactome</li>
        </ul>
    </div>
</div> <!-- end breadcrumbs -->
...
<div class="row-fluid">
    <div class="span12">
        <h2>Human Proteasome Interactome</h2>
        <p>
