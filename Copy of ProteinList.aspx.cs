...
public partial class ProteinList : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if ((!Page.IsPostBack) && T!=null )
        {
            ...
            proteinKey.Text = V;
            if (ProteinName == null && T.StartsWith ("Gene"))
                 QueryGeneSymbol(V);
            else
    ...
    private void QueryGeneSymbol(string GSymbol)
    { 
        ...
        string strSQL = string.Format("select distinct t.protein_cop_id,t.gene_symbol,t.protein_name,t.organism_source from protein_tbl t where  t.gene_symbol = '{0}' ", DBInterface.SQLValidString(GSymbol ).ToUpper ());
