...
<html>
<head>
	<title>Cardiac Organellar Protein Atlas Knowledgebase (COPaKB) -- Image Gallery</title>
</head>
<body>
    ...
    <form id="Form1" runat="server" enctype="multipart/form-data">  
		...
		<FTB:ImageGallery id="ImageGallery1" 
			...
			AllowImageDelete=false AllowImageUpload=true AllowDirectoryCreate=true AllowDirectoryDelete=false runat="Server" />
