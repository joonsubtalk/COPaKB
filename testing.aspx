...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="testing.aspx.cs" Inherits="testing" Title="Cardiac Organellar Protein Atlas Knowledgebase (COPaKB) —— Reprot View" %>
                            ...
                            <div class="span12">
                                <asp:Table ID="tbProteins" class="table-hover" runat="server" BackColor="White">
                                    <asp:TableRow ID="TableRow1" runat="server" BackColor="#99CCFF">
                                        ...
                                        BorderWidth="1px"  HorizontalAlign="Left" >Quantitate Value</asp:TableCell>
                                    </asp:TableRow>
                                </asp:Table>
                            </div>
                        </div>
