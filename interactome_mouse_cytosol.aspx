<%@ Page Title="Cardiac Organellar Protein Atlas Knowledgebase (COPaKB) —— Interactome Mouse Cytosol" Language="C#" MasterPageFile="~/COPaKB.master" AutoEventWireup="true" CodeFile="interactome_mouse_cytosol.aspx.cs" Inherits="interactome_drosophila_mitochondria" %>
...
<div class="row-fluid">
    <div class="span12">
        <ul class="breadcrumb">
          ...
          <li class="active">Mouse Cytosol Interactome</li>
        </ul>
    </div>
</div> <!-- end breadcrumbs -->
...
<div class="row-fluid">
    <div class="span12">
        <h2>Mouse Cytosol Interactome</h2>
        <p>
