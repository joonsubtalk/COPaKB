<%@ Page Title="Cardiac Organellar Protein Atlas Knowledgebase (COPaKB) —— Protein List" Language="C#" MasterPageFile="~/COPaKB.master" AutoEventWireup="true" CodeFile="Copy of ProteinList.aspx.cs" Inherits="ProteinList" %>
