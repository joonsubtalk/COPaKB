...
a.selectedTab { color: #000; display: block; width:80px; border: 1px solid #aaa; border-top: 1px solid #fff; border-left: 1px solid #fff; padding: 24px; margin:0px; background-color: #Edf0D9;}\
a.unselectedTab { color: #000; display: block; width:80px; border: 0; padding: 25px; margin:0px; background-color: #ECE9D8;}\
